<template>
    <div>
        <section class="level">
            ...
            <div class="hero level-item is-fullheight column"
                :style="{ 'background-image': 'url(https://media.karousell.com/media/photos/products/2021/11/7/sea_aquarium_adult_today_1636250321_b32b7c12.jpg)' }">
            </div>
        </section>
    </div>
</template>
...
export default {
    ...
    methods: {
        submit() {
            ...
            axios.post('http://3.215.49.113:3000/user/login/', data)
                .then(res => {
